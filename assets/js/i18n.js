...
const DICT = {
  en: {
    ...
    'exam.gate.help': 'Type your access key: the word "{prefix}" followed by your ID number, with no spaces or dashes. Your exam version is assigned automatically from your ID.',
    'exam.gate.placeholder': '{prefix}1234567890',
    'exam.gate.format': 'Type "{prefix}" before your ID number — for example {prefix}1234567890.',
    'exam.back': 'Back',
    'exam.gate.open': 'Open',
    'exam.gate.word': 'Session word',
    'exam.gate.wordHelp': 'The word your professor says at the start of the session.',
  ...
  es: {
    ...
    'exam.gate.help': 'Escriba su clave de acceso: la palabra «{prefix}» seguida de su número de cédula, sin espacios ni guiones. La versión del parcial se asigna automáticamente a partir de su cédula.',
    'exam.gate.placeholder': '{prefix}1234567890',
    'exam.gate.format': 'Debe escribir «{prefix}» antes de su número de cédula — por ejemplo {prefix}1234567890.',
    'exam.back': 'Volver',
    'exam.gate.open': 'Abrir',
    'exam.gate.word': 'Palabra de la sesión',
    'exam.gate.wordHelp': 'La palabra que su profesor dice al comenzar la sesión.',
