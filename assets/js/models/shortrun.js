      ...
      build(out1, out2, p1, p2, t) {
        return {
          traces: [
            ...
            { x: out2.series.gGrid, y: out2.series.mpBench, name: `${t('trace.shortrun.mpBench')} (2)`, scenario: 2, dash: 'dot', role: 'aux' },
